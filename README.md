...
Methodology
AutoML: Utilized PyCaret for rapid model comparison and tuning.

Feature Engineering: Created custom features to capture unexplained variance, including:

Volume (Diameter × Length × Height).

Weight_diff (Whole weight minus the sum of shucked, viscera, and shell weights).

Modeling: Evaluated various regression models, identifying Gradient Boosting as the top individual performer.
